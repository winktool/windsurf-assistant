...
USERS = {
    ...
    'Administrator': Path(r'C:\\Users\\YOUR_USER\AppData\Roaming\Windsurf'),
}
EXT_JS_PATH = Path(r'D:\Windsurf\resources\app\extensions\windsurf\dist\extension.js')
EXHAUSTED_KEY_PREFIXES = ['sk-ws-01-EXAMPLE']  # known exhausted keys
...
if EXT_JS_PATH.exists():
    ...
    correct_path = r'"C:\\Users\\YOUR_USER\\AppData\\Roaming\\Windsurf\\_pool_apikey.txt"'
