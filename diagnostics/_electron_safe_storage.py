...
USERS = {
    ...
    'Administrator': {
        'local_state': Path(r'C:\\Users\\YOUR_USER\AppData\Roaming\Windsurf\Local State'),
        'state_db': Path(r'C:\\Users\\YOUR_USER\AppData\Roaming\Windsurf\User\globalStorage\state.vscdb'),
    },
}
